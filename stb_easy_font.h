...
//
// Public domain. See end of file for alternative MIT license.
...
static int stb_easy_font_draw_segs(float x, float y, unsigned char *segs, int num_segs,
                                    int vertical, stb_easy_font_color c,
...
static int stb_easy_font_print(float x, float y, const char *text, unsigned char color[4],
