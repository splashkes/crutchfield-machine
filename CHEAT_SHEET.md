...
One-page reference. Print it, tape it by the rig.

For the *why* of any of this see [development/LAYERS.md](development/LAYERS.md),
[development/ARCHITECTURE.md](development/ARCHITECTURE.md), or
[development/DESIGN.md](development/DESIGN.md). This doc is just the
**what** and the **which key**.
